...
lq_j = LQJump(T=1.0, N=100, dim_x=1, dim_w=2, dim_n=1, theta=0.3, vol=0.2, rates=[5.0], jump_means=[0.0],
              jump_sds=[0.05], jump_type="Normal", common_noise="Brownian",
              path="C:/Users/jan1r/Documents/Faks/Doktorat/CommonNoise/Graphs/NewGraphs/lq_j/")
...
lq_cj = LQCommonJump(T=1.0, N=100, dim_x=1, dim_w=1, dim_n=2, rates=[5.0, 5.0], jump_means=[0.0, 0.0],
              ...
              path="C:/Users/jan1r/Documents/Faks/Doktorat/CommonNoise/Graphs/NewGraphs/lq_cj/")



solver = DeepSolver(math_model=lq_cj, batch_size=2**10, eval_size=2**10, learning_rate=0.0005, n_epochs=200, ridge_param=0.1, depth=2)
...
state_seq_true, control_seq_true, cex_seq_true, loss_true = lq_cj.explicit_solution(dW, dP, common_noise, state_seq)
